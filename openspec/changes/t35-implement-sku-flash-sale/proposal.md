...
- Release a traffic lease only on successful order creation or its 300-second deadline; preview, failure, browser closure and leaving the page do not release it early. Release a confirmation request slot when its processing finishes, independently of lease expiry.
