...
const allowed: Readonly<Record<PurchasePaymentStatus, readonly PurchasePaymentStatus[]>> = {
  UNPAID: ['PENDING'],
  PENDING: ['UNKNOWN', 'PENDING_RECONCILIATION', 'PAID', 'FAILED', 'CANCELLED', 'EXPIRED'],
  UNKNOWN: ['PENDING_RECONCILIATION', 'PAID', 'FAILED', 'CANCELLED', 'EXPIRED'],
  PENDING_RECONCILIATION: ['PAID', 'FAILED', 'CANCELLED', 'EXPIRED'],
