...
@Module({ imports: [AuthModule], controllers: [SellerPromotionsController], providers: [SellerPromotionsExceptionFilter, SellerPromotionsService, SellerShopScopeService], exports: [SellerPromotionsService] })
