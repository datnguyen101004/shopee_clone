...
function FaMoneyBillWave({ className }: { className?: string }) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 576 512" fill="currentColor" aria-hidden="true">
...
function FaBox({ className }: { className?: string }) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 448 512" fill="currentColor" aria-hidden="true">
          ...
          <div className="seller-dashboard-grid">
            ...
            <section className="seller-dashboard-panel">
              ...
              {data.bestSellers.length ? (
                    ...
                    <li key={item.productId}>
                      ...
                      <div className="seller-product-item-info">
                        {item.currentProductAvailable ? (
                          <Link href={`/products/${item.productId}`} className="seller-product-link">
                ...
                <p className="seller-dashboard-empty">Chưa có đơn hợp lệ trong khoảng thời gian này.</p>
              )}
            </section>
          </div>
