...
export const seedImages = [
  ...
  },
  {
    ...
    productId: seedProducts[0].id,
    variantId: seedVariants[0].id,
    url: '/media/products/smartphone-pro.svg',
    altText: 'Smartphone Pro 128GB màu đen',
    sortOrder: 10,
  },
  {
    id: '00000000-0000-4000-8000-000000000515',
    productId: seedProducts[0].id,
    variantId: seedVariants[1].id,
    url: '/media/products/smartphone-pro.jpg',
    altText: 'Smartphone Pro 256GB màu bạc',
    sortOrder: 20,
  },
  {
