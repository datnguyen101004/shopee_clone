...
export class PricingController {
  ...
  @ApiOkResponse({
    description: 'Validated pricing-v2, voucher-v1, and versioned carrier authoritative quote',
    schema: {
      type: 'object',
      required: [
        'pricingVersion',
      ...
      properties: {
        ...
        shippingVersion: { type: 'string', enum: ['mock-v1', 'demo-distance-v1'] },
            ...
            properties: {
              ...
              shipping: {
                ...
                oneOf: [
                  {
                    type: 'object',
                    required: ['provider', 'version', 'originProvinceCode', 'originDistrictCode', 'originDistrict', 'destinationProvinceCode', 'destinationDistrictCode', 'destinationDistrict', 'simulation', 'straightLineDistanceKm', 'estimatedDistanceKm', 'billableDistanceKm', 'nearDistanceFeeMinor', 'longDistanceFeeMinor', 'weightFeeMinor', 'calculationVersion', 'locationSnapshotVersion'],
                    properties: {
                      provider: { type: 'string', enum: ['DEMO_CARRIER'] },
                      version: { type: 'string', enum: ['demo-distance-v1'] },
                      originProvinceCode: { type: 'string' },
                      originDistrictCode: { type: 'string' },
                      originDistrict: { type: 'string' },
                      destinationProvinceCode: { type: 'string' },
                      destinationDistrictCode: { type: 'string' },
                      destinationDistrict: { type: 'string' },
                      simulation: { type: 'boolean', enum: [true] },
                      straightLineDistanceKm: { type: 'number', minimum: 0 },
                      estimatedDistanceKm: { type: 'integer', minimum: 3 },
                      billableDistanceKm: { type: 'integer', minimum: 3, maximum: 2000 },
                      nearDistanceFeeMinor: { type: 'integer', minimum: 0 },
                      longDistanceFeeMinor: { type: 'integer', minimum: 0 },
                      weightFeeMinor: { type: 'integer', minimum: 0 },
                      calculationVersion: { type: 'string', enum: ['demo-distance-v1'] },
                      locationSnapshotVersion: { type: 'string' },
                    },
                  },
                  {
                    type: 'object',
                    ...
                    properties: {
                      ...
                      zone: { type: 'string', enum: ['SAME_PROVINCE', 'SAME_REGION', 'CROSS_REGION', 'UNKNOWN'] },
                      shipmentWeightGrams: { type: 'integer', minimum: 1 },
