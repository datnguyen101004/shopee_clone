...
@Module({ imports: [AuthModule], controllers: [SellerProductsController, SellerProductMediaController], providers: [SellerProductsExceptionFilter, SellerProductMediaStorage, SellerProductsService] })
