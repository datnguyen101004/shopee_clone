...
export type LegacyProvince = Readonly<{
  code: string;
  name: string;
  districts: readonly LegacyDistrict[];
}>;

/**
 * Vietnam's pre-consolidation 63-province, district-level snapshot.
 * Generated from the National Statistics Office web service for 30 June 2025.
 */
export const LEGACY_VIETNAM_PROVINCES = [
  {
    code: '01',
  ...
  },
  {
    ...
    districts: [
      ...
      { code: '172', name: 'Thành phố Phổ Yên' },
  ...
  },
  {
    ...
    districts: [
      ...
      { code: '205', name: 'Thành phố Đông Triều' },
      { code: '206', name: 'Thị xã Quảng Yên' },
      { code: '207', name: 'Huyện Cô Tô' },
    ],
  },
  {
    code: '24',
    ...
    districts: [
      ...
      { code: '222', name: 'Thị Xã Việt Yên' },
      { code: '223', name: 'Huyện Hiệp Hòa' },
      { code: '224', name: 'Thị xã Chũ' },
    ],
  },
  {
    code: '25',
  ...
  },
  {
    ...
    districts: [
      ...
      { code: '261', name: 'Thành phố Từ Sơn' },
      { code: '262', name: 'Thị xã Thuận Thành' },
  ...
  },
  {
    ...
    districts: [
      ...
      { code: '311', name: 'Thành phố Thuỷ Nguyên' },
      { code: '312', name: 'Quận An Dương' },
  ...
  },
  {
    ...
    districts: [
      ...
      { code: '374', name: 'Thành phố Hoa Lư' },
  ...
  },
  {
    ...
    districts: [
      ...
      { code: '753', name: 'Huyện Long Đất' },
      { code: '754', name: 'Thành phố Phú Mỹ' },
  ...
  },
  {
    ...
    districts: [
      ...
      { code: '816', name: 'Thành phố Gò Công' },
  ...
  },
  {
    ...
    districts: [
      ...
      { code: '868', name: 'Thành phố Hồng Ngự' },
...
] as const satisfies readonly LegacyProvince[];
